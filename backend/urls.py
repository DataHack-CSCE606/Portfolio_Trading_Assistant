...
from .api.views import check_stock, index_view, MessageViewSet, get_profile, set_profile, stock_detail, google_login, google_logout, add_new_stock, delete_stock, stock_detail, set_stock
